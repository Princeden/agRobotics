...
def generate_launch_description():
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/phom/agrobotics_ws/robot_yaml/platform/config/imu_filter.yaml',
        description='')
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/phom/agrobotics_ws/robot_yaml/'
                )
                ,
                (
                    'use_sim_time'
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/phom/agrobotics_ws/robot_yaml/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
